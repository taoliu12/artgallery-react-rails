...
namespace :db do
  ...
  task seed_events: :environment do
    ...
    Event.create(
      title: "Modern Korean Architecture in Photos",
      event_type: "Gallery Exhibition",
